...
test("Formula 1 Ranking", () => {
  ...
  const results: string[][] = [
    [ "M. Schumacher", "R. Barrichello", "D. Coulthard", "M. Häkkinen", "A. Wurz", "J. Villeneuve", ],
    [ "M. Schumacher", "M. Häkkinen", "R. Barrichello", "R. Schumacher", "A. Wurz", "D. Coulthard", ],
  ];
  const expected: Map<string, number> = new Map([
    ["M. Schumacher", 20], ["R. Barrichello", 10], ["M. Häkkinen", 9], ["D. Coulthard", 5],
    ["A. Wurz", 4], ["R. Schumacher", 3], ["J. Villeneuve", 1],
  ]);
